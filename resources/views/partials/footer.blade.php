        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm text-white/70">
                    ...
                    <li><a href="{{ route('shop') }}" class="hover:text-secondary transition-colors">All Products</a></li>
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm text-white/70">
                    <li><a href="{{ route('shop', ['category' => 'paper-products']) }}" class="hover:text-secondary transition-colors">Paper Products</a></li>
                    <li><a href="{{ route('shop', ['category' => 'stamp-pads']) }}" class="hover:text-secondary transition-colors">Stamp Pads</a></li>
                    <li><a href="{{ route('shop', ['category' => 'rubber-seals']) }}" class="hover:text-secondary transition-colors">Rubber Seals</a></li>
                    <li><a href="{{ route('shop', ['category' => 'screen-printing-materials']) }}" class="hover:text-secondary transition-colors">Screen Printing</a></li>
                </ul>
            </div>
