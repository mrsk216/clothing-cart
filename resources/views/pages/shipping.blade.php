...
<div class="max-w-4xl mx-auto px-4 py-8">
    ...
    <h1 class="text-3xl font-serif font-bold text-primary mb-6">Shipping Policy</h1>
    <div class="card p-6 prose max-w-none text-gray-700">
        <h2 class="text-xl font-serif font-bold text-primary mt-6 mb-3">Delivery Time</h2>
        ...
        <h2 class="text-xl font-serif font-bold text-primary mt-6 mb-3">Shipping Charges</h2>
        <p>Free shipping on orders above ₹500. For orders below ₹500, a nominal shipping charge of ₹50 applies.</p>
        <h2 class="text-xl font-serif font-bold text-primary mt-6 mb-3">Order Tracking</h2>
