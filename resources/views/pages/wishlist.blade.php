                ...
                <div class="product-card">
                    ...
                    <div class="p-4">
                        ...
                        <div class="product-actions">
                            ...
                            <button onclick="removeFromWishlist({{ $wishlist->id }})" class="w-10 h-10 bg-white rounded-lg shadow flex items-center justify-center text-gray-600 hover:text-error">
...
function removeFromWishlist(id) {
    if (confirm('Remove from wishlist?')) {
        fetch(`/wishlist/${id}`, { method: 'DELETE', headers: { 'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content } })
