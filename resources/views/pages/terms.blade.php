...
<div class="max-w-4xl mx-auto px-4 py-8">
    ...
    <h1 class="text-3xl font-serif font-bold text-primary mb-6">Terms & Conditions</h1>
    <div class="card p-6 prose max-w-none text-gray-700">
        <h2 class="text-xl font-serif font-bold text-primary mt-6 mb-3">Acceptance of Terms</h2>
        <p>By accessing and using this website, you accept and agree to be bound by the terms and provision of this agreement.</p>
        <h2 class="text-xl font-serif font-bold text-primary mt-6 mb-3">Use of the Website</h2>
        ...
        <h2 class="text-xl font-serif font-bold text-primary mt-6 mb-3">Pricing and Payment</h2>
