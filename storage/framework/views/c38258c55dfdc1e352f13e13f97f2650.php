...
<div class="p-6">
    ...
    <div class="card p-6">
        <form method="POST" action="<?php echo e(route('admin.products.store')); ?>" class="space-y-6" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="grid md:grid-cols-2 gap-6">
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Product Name *</label>
                    <input type="text" name="name" value="<?php echo e(old('name')); ?>" required class="input-field" placeholder="Enter product name">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <input type="text" name="slug" value="<?php echo e(old('slug')); ?>" required class="input-field" placeholder="product-url-slug">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <textarea name="short_description" rows="2" class="input-field" placeholder="Short description..."><?php echo e(old('short_description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="description" rows="4" class="input-field" placeholder="Product description..."><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <input type="number" name="price" step="0.01" value="<?php echo e(old('price')); ?>" required class="input-field" placeholder="0.00">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <input type="number" name="compare_price" step="0.01" value="<?php echo e(old('compare_price')); ?>" class="input-field" placeholder="0.00">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <input type="number" name="stock_quantity" value="<?php echo e(old('stock_quantity')); ?>" required class="input-field" placeholder="0">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <input type="text" name="sku" value="<?php echo e(old('sku')); ?>" class="input-field" placeholder="SKU-001">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <select name="is_active" class="input-field">
                        ...
                        <option value="0" <?php echo e(old('is_active', 1) == 0 ? 'selected' : ''); ?>>Inactive</option>
                    </select>
                </div>

                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Weight (kg)</label>
                    <input type="number" name="weight" step="0.01" value="<?php echo e(old('weight')); ?>" class="input-field" placeholder="0.00">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <input type="number" name="length" step="0.01" value="<?php echo e(old('length')); ?>" class="input-field" placeholder="0.00">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <input type="number" name="width" step="0.01" value="<?php echo e(old('width')); ?>" class="input-field" placeholder="0.00">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <input type="number" name="height" step="0.01" value="<?php echo e(old('height')); ?>" class="input-field" placeholder="0.00">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <input type="text" name="meta_title" value="<?php echo e(old('meta_title')); ?>" class="input-field" placeholder="SEO title">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <textarea name="meta_description" rows="2" class="input-field" placeholder="SEO description"><?php echo e(old('meta_description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <input type="text" name="tags" value="<?php echo e(old('tags')); ?>" class="input-field" placeholder="tag1, tag2, tag3">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <textarea name="specifications" rows="3" class="input-field" placeholder='{"Brand": "XYZ", "Material": "Paper"}'><?php echo e(old('specifications')); ?></textarea>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Projects\dr.Rajendra\project 001\spmApp\resources\views/admin/products/create.blade.php ENDPATH**/ ?>