...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="flex flex-col gap-6">
        <div class="text-center">
            <h2 class="text-2xl font-bold text-primary"><?php echo e(__('Reset Password')); ?></h2>
            <p class="text-gray-500 mt-1 text-sm"><?php echo e(__('Please enter your new password below')); ?></p>
        </div>
...
<?php endif; ?>
        ...
        <form method="POST" action="<?php echo e(route('password.update')); ?>" class="flex flex-col gap-5">
            <?php echo csrf_field(); ?>
            <!-- Token -->
...
<?php endif; ?>
<?php /**PATH F:\Projects\dr.Rajendra\project 001\spmApp\resources\views/pages/auth/reset-password.blade.php ENDPATH**/ ?>