...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="flex flex-col gap-6">
        <div class="text-center">
            <h2 class="text-2xl font-bold text-primary"><?php echo e(__('Forgot Password?')); ?></h2>
            <p class="text-gray-500 mt-1 text-sm"><?php echo e(__('Enter your email to receive a password reset link')); ?></p>
        </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="text-center text-sm text-gray-500">
            <span><?php echo e(__('Remember your password?')); ?></span>
            <a href="<?php echo e(route('login')); ?>" class="text-secondary font-medium hover:underline ml-1">
...
<?php endif; ?>
<?php /**PATH F:\Projects\dr.Rajendra\project 001\spmApp\resources\views/pages/auth/forgot-password.blade.php ENDPATH**/ ?>