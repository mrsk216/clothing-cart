<?php $__env->startSection('title', $siteName() . ' - Paper, Stamp Pad, Rubber Seal & Screen Printing Materials'); ?>

<?php $__env->startSection('meta_description', 'Your trusted source for premium paper products, stamp pads, rubber seals, and screen printing materials. Quality products with fast delivery across India.'); ?>

<?php $__env->startSection('meta_keywords', 'paper products, stamp pads, rubber seals, screen printing materials, A4 paper, custom stamps'); ?>
            ...
            <div class="relative max-w-7xl mx-auto px-4 py-20">
                <div class="grid md:grid-cols-2 gap-12 items-center">
                    <div class="animate-fade-in">
                        <span class="inline-block bg-secondary/20 text-secondary px-4 py-1 rounded-full text-sm font-medium mb-4">Welcome to <?php echo e($siteName()); ?></span>
                        ...
                        <div class="flex flex-wrap gap-4">
                            <a href="<?php echo e(route('shop')); ?>" class="bg-secondary text-white px-8 py-3.5 rounded-lg font-semibold text-lg hover:bg-secondary-dark transition-all duration-300 inline-flex items-center gap-2">
                                Shop Now
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"/></svg>
                            </a>
                            <a href="<?php echo e(route('contact')); ?>" class="border-2 border-white/30 text-white px-8 py-3.5 rounded-lg font-semibold hover:bg-white/10 transition-all duration-300 inline-flex items-center gap-2">
                                Contact Us
                            </a>
                        </div>
                        <!-- Trust Stats -->
        ...
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $categories->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <a href="<?php echo e(route('shop', ['category' => $category->slug])); ?>" class="card p-6 text-center group hover:border-secondary/50 transition-all duration-300">
                        <div class="w-20 h-20 bg-secondary/10 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:bg-secondary/20 transition-colors">
                            <span class="text-3xl"><?php echo e($category->image); ?></span>
                        </div>
                        <h3 class="font-semibold text-primary text-lg mb-2"><?php echo e($category->name); ?></h3>
                        <p class="text-sm text-gray-500"><?php echo e($category->description ?? Str::limit($category->name . ' - High quality products', 60)); ?></p>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($category->children->count() > 0): ?>
                            <div class="mt-3 flex flex-wrap justify-center gap-1">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $category->children->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <span class="text-xs bg-gray-100 text-gray-600 px-2 py-1 rounded-full"><?php echo e($child->name); ?></span>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($category->children->count() > 3): ?>
                                    <span class="text-xs text-secondary">+<?php echo e($category->children->count() - 3); ?> more</span>
                    ...
                    <div class="product-card">
                        ...
                        <div class="p-4">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->category): ?>
                                <span class="text-xs text-secondary font-medium"><?php echo e($product->category->name); ?></span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="bg-gradient-to-r from-primary to-primary-light rounded-2xl p-8 md:p-12 text-white relative overflow-hidden">
                ...
                <div class="relative grid md:grid-cols-2 gap-8 items-center">
                    <div>
                        ...
                        <a href="<?php echo e(route('contact')); ?>" class="inline-flex items-center gap-2 bg-secondary text-primary px-6 py-3 rounded-lg font-semibold hover:bg-secondary-light transition-colors">
                            Get Quote
