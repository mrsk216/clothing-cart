...
<div class="max-w-7xl mx-auto px-4 py-8">
    ...
    <h1 class="text-2xl font-serif font-bold text-primary mb-6">My Wishlist</h1>

    @if($wishlists->count() > 0)
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            @foreach($wishlists as $wishlist)
                <div class="product-card">
                    <a href="{{ route('product.detail', $wishlist->product->slug) }}" class="block fashion-product-image">
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex gap-3">
                            ...
                            <a href="{{ route('wishlist.delete', $wishlist->id) }}" onclick="confirm('Remove from wishlist?')" class="w-10 h-10 bg-white rounded-full shadow flex items-center justify-center text-gray-600 hover:text-error">
