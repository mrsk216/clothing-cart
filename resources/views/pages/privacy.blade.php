...
<div class="max-w-4xl mx-auto px-4 py-8">
    ...
    <h1 class="text-3xl font-serif font-bold text-primary mb-6">Privacy Policy</h1>
    <div class="card p-6 prose max-w-none text-gray-700">
        <p>Last updated: {{ date('d M Y') }}</p>
        <h2 class="text-xl font-serif font-bold text-primary mt-6 mb-3">Information We Collect</h2>
        ...
        <h2 class="text-xl font-serif font-bold text-primary mt-6 mb-3">How We Use Your Information</h2>
        <p>We use the information we collect to process orders, communicate with you about your orders, and improve our services.</p>
        <h2 class="text-xl font-serif font-bold text-primary mt-6 mb-3">Data Security</h2>
