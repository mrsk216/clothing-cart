                ...
                <div class="product-card">
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex gap-3">
                            ...
                            <a href="{{ route('wishlist/', $wishlist->product->id) }}" onclick="confirm('Remove from wishlist?')" class="w-10 h-10 bg-white rounded-lg shadow flex items-center justify-center text-gray-600 hover:text-error">
